                    ...
                    <section class="w-80">
                        <div class="cf w-100">
                            ...
                            <div class="fl w-100 pt3">
                                <form class="tl pa4 mw6 cf center b--light-blue bg-shadow flex flex-column  black" action="{{url('/dashboard/category/create')}}" method="POST" enctype="multipart/form-data" autocomplete="off">
                                    {{ csrf_field() }}
