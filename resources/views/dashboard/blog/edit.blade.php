                    ...
                    <section class="w-80">
                        <div class="cf w-100">
                            ...
                            <div class="fl w-100 pt3">
                                <form class="tl pa3 mw6 cf center bg-shadow flex flex-column  black"  action="/dashboard/blog/<?php echo $blog['id']; ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
                                    {{ csrf_field() }}
                                    <div class="mv1 fl w-100">
                                        <label class="pv1 f6">Title</label>
                                        <div class="bg-white br1 ba b--light-blue">
                                            <input type="text" name="name" class="w-100 br2 bn pa1" value ='<?php echo$blog['name']; ?>'/>
                                        </div>
                                    </div>
                                    <div class="mv1 fl w-100">
                                    ...
                                    <div class="mv1 fl w-100">
                                        ...
                                        <div class="bg-white br1 ba b--light-blue">
                                            <textarea name="description" class="w-100 br2 bn pa1">{{$blog['description']}}</textarea>
                                        </div>
                                    </div>
                                    <div class="mv1 fl w-100">
